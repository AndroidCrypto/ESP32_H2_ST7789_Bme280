/*
  This sketch shows how to work with the ESP32-H2 Supermini development board.
...
/*
13.05.2025 V03 Pin changing, uses setCpuFrequency for changing the cpu frequency
29.04.2025 V02 AP = Alternative Pinout, trying to use pins on the other side of the board
               (9-14) instead of (0-5) as they are Analog Pins:
               BL goes from pin 3 to pin 13 = onboard LED 
Version Management
23.04.2025 V01 Initial programming
*/

/*
TFT 240 x 320 pixels 2.0 inch ST7789 display wiring to an ESP32-H2 Supermini
Terminals on display's pcb from left to right

-= Alternative Pinout =-
Note: leave out pins 8 = RGB LED and 9
TFT   ESP32-H2
GND   GND
VDD   3.3V 
SCL   0
...
const char *PROGRAM_VERSION = "ESP32-H2 Supermini ST7789 BME280 V03";
const char *PROGRAM_VERSION_SHORT = "ESP32-H2 ST7789 BME280 V03";
const char *DIVIDER = "--------------------";
...
#define TFT_BL_PIN 24  // backlight brightness control, needs to be a PWM pin
#define TFT_BRIGHTNESS_PERCENT 90  // avoids overheating of the device
#define TFT_TEMPERATURE_METER_START 257
...
// -------------------------------------------------------------------------------
// CPU frequency
//#define CPU_FREQUENCY_MHZ 96 // 96 |64 | 48 | 32 MHz
#define CPU_FREQUENCY_MHZ 32 // 96 |64 | 48 | 32 MHz
